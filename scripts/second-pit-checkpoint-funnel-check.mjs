...
for(const needle of ["SECOND_PIT_FUNNEL_HALF_X=2.05","SECOND_PIT_FUNNEL_Z_MIN=5.78","SECOND_PIT_FUNNEL_Z_MAX=7.28","inSecondPitFunnel(x,z","playerLandingFunnel","brainLandingFunnel","Math.exp(-15*dt)"]){if(!s.includes(needle))throw new Error('missing '+needle)}
